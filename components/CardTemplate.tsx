...
export default function CardTemplate({
    ...
    const maxChar = 100;
    const descriptionExceedsLimit = description.length > maxChar;
    const displayedDescription = showFullDescription || !descriptionExceedsLimit ? description : `${description.substring(0, maxChar)}...`;
